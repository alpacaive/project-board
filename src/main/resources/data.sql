...
insert into user_account(user_id, user_password, nickname, email, memo, created_at, created_by, modified_at,
                         modified_by)
values ('alpacaive', '1234', 'Zeus', 'alpacaive@mail.com', 'God Thunder', now(), 'alpacaive', now(), 'alpacaive')
;

insert into user_account(user_id, user_password, nickname, email, memo, created_at, created_by, modified_at,
                         modified_by)
values ('alpacaive2', '1234', 'Zeus2', 'alpacaive2@mail.com', 'God Thunder2', now(), 'alpacaive2', now(), 'alpacaive2')
;
